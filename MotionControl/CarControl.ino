...
/*    PREPROGRAMMED PATH     */
/*---------------------------*/
int run_times[NUM_COMMANDS] = {10000, 6000, 2500, 4500}; // length of commands roughly in ms
...
float delta_reference(int i) {
  float newv_star = v_star/5;
  float newDelta_ss = CAR_WIDTH * newv_star * i / TURN_RADIUS;
